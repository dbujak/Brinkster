<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="Brinkster._default13"%>
						...
						<H3>
							<TABLE id="Table5" cellSpacing="1" cellPadding="3" border="0">
								...
								<TR>
									...
									<TD vAlign="top">
										<P><STRONG>New Second Level:</STRONG>
										</P>
										<UL>
											<LI>
											Master Bedroom
								...
								<TR>
									<TD vAlign="top" align="left" style="HEIGHT: 57px"></TD>
									<TD vAlign="top" colSpan="2" style="HEIGHT: 57px">
										<P align="center">For more pictures and virtual tour please click here:</P>
										<P align="center"><A href="#" onclick="window.open('http://www.circlepix.com/tour.htm?id=434661&amp;refurl=reStudio.biz', '_blank', 'status,toolbars,scrollbars,width=800,height=440,left=30,top=35');">http://www.circlepix.com/tour.htm?id=434661</A>
										</P>
									</TD>
								</TR>
								<TR>
