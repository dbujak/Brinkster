<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Footer.ascx.vb" Inherits="Brinkster.Footer2" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<style type="text/css">
...
<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<TR>
		<TD bgColor="#666666" height="25"><center><asp:label id="Label1" runat="server"><span class="footer"><a href="http://flahertygroup.com/" target="_blank">Flaherty 
						...
						<b>direct:</b> 301.637.2866 &nbsp; &nbsp; &nbsp; <b>office:</b> 301.946.3900 
						&nbsp; &nbsp; &nbsp; <b>fax:</b> 240.363.8900<br><b>web:</b> www.kensingtonteam.com</span></asp:label></center>
		</TD>
	</TR>
	<TR>
