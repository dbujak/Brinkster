<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="Brinkster._default40"%>
...
<HTML>
	<HEAD>
		<title>Potomac Search - Flaherty Potomac Team</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					<TD vAlign="top"></TD>
					<TD vAlign="top">
					<script src="http://idx.diversesolutions.com/scripts/controls/Remote-Frame.aspx?MasterAccountID=1340&amp;SearchSetupID=20&amp;LinkID=61887&amp;Height=2000"></script>
					</TD>
					<TD vAlign="top"></TD>
					<TD vAlign="top"></TD>
				</TR>
