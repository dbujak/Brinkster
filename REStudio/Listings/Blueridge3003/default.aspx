<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="Brinkster._default49"%>
...
<%@ Register TagPrefix="uc1" TagName="Blueridge3003" Src="Blueridge3003.ascx" %>
			...
			<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					...
					<TD vAlign="top" width="100%">
						<P>
							<uc1:Blueridge3003 id="Blueridge30031" runat="server"></uc1:Blueridge3003></P>
					</TD>
					<TD vAlign="top"></TD>
