<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="Brinkster._default50"%>
...
<%@ Register TagPrefix="uc1" TagName="DarcyForest" Src="DarcyForest.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>9820 Darcy Forest Drive - By Dejan Bujak</title>
			...
			<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TR>
					...
					<TD vAlign="top" width="100%">
						<P>
							<uc1:DarcyForest id="DarcyForest1" runat="server"></uc1:DarcyForest></P>
					</TD>
					<TD vAlign="top"></TD>
