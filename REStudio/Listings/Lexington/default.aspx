<%@ Register TagPrefix="uc1" TagName="Lexington" Src="/Brinkster/RENOVATIONSTUDIO/Projects/Lexington/Lexington.ascx" %>
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="Brinkster._default19"%>
...
<HTML>
	<HEAD>
		<title>Dejan Bujak - 10703 Lexington St, Kensington, MD 20895</title>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="95%" border="0">
				...
				<TR>
					...
					<TD vAlign="top" width="100%">
						<P><BR>
							<uc1:Lexington id="Lexington1" runat="server"></uc1:Lexington><BR>
						</P>
					</TD>
					<TD vAlign="top"></TD>
