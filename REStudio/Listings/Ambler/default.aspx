<%@ Page Language="vb" AutoEventWireup="false" Codebehind="default.aspx.vb" Inherits="Brinkster._default21"%>
...
<%@ Register TagPrefix="uc1" TagName="Ambler" Src="Ambler.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<HTML>
	<HEAD>
		<title>Dejan Bujak - 4302 Ambler Dr; Kensington, MD 20895</title>
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="95%" border="0">
				...
				<TR>
					...
					<TD vAlign="top" width="100%">
						<P><BR>
							<uc1:Ambler id="Ambler1" runat="server"></uc1:Ambler><BR>
						</P>
						<P>&nbsp;</P>
					</TD>
					<TD vAlign="top"></TD>
